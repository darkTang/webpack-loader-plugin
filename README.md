...
![loader执行流程](https://yk2012.github.io/sgg_webpack5/imgs/source/loader1.png)

在这个过程中如果任何 pitch 有返回值，则 loader 链被阻断。webpack 会跳过后面所有的的 pitch 和 loader，直接进入上一个 loader 。

![loader执行流程](https://yk2012.github.io/sgg_webpack5/imgs/source/loader2.png)
...
> 更多文档，请查阅 [webpack 官方 loader api 文档open in new window](https://webpack.docschina.org/api/loaders/#the-loader-context)
